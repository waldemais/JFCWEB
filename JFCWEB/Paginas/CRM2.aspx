                                ...
                                <table style="width:100%;">
                                    ...
                                    <tr>
                                        <td class="auto-style4" colspan="3"><strong>
                                            ...
                                            <asp:Button ID="Button2" runat="server" BackColor="#E7F3D6" CssClass="auto-style5" ForeColor="#009933" Text="Não-Procedente" Width="150px" PostBackUrl="~/Paginas/CrmNaoProcede.aspx" />
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style8">
                                            <br />
                                            <asp:HyperLink ID="hplnkExibeImagem" runat="server" NavigateUrl="~/Paginas/ExibirImagem.aspx" Font-Bold="True" ForeColor="#009933" Target="_blank">Click aqui para exibir a Imagem</asp:HyperLink>
                                        </td>
                                        <td class="auto-style2"></td>
                                    </tr>
                                </table>
