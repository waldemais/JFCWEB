...
{
    public partial class CrmNaoProcede : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            comm.Parameters.AddWithValue("@O", TextBox3.Text);
            ...
            try
            {
                ...
                var Esol = (GridView1.Rows[0].Cells[5].Text);
                ...
                mailMessage.Body = "A Solicitação foi NÃO Procedente " + "<br>" + corpo;
                ...
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "sua-mensagem", "alert('O solicitante recebeu a informação!')", true);
            }
            catch
            {
