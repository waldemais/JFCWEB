...
{
    public partial class ExportaExcelSubway : System.Web.UI.Page
    {
    ...
    string strConnstring = "Data Source=mssql02-farm22.kinghost.net;Initial Catalog=jfcverduras;Integrated Security=True;Pooling=False";
        ...
        protected void BtnExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Subway_RJ_MG.xls");
            Response.Charset = "";
        ...
        protected void BtnExcel1_Click(object sender, EventArgs e)
        {
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=Subway_SP.xls");
            Response.Charset = "";
            Response.ContentType = "application/vnd.ms-excel";
            using (StringWriter sw1 = new StringWriter())
            {
                ...
                foreach (GridViewRow row in dgv1.Rows)
                {
                    ...
                    // ("UPDATE PEDIDO SET STATUS = 'FINALIZADO' WHERE DTENTREGA = @ENTREGA AND STATUS='ABERTO' AND UF='SP'");
        ...
        protected void BtnPrevia_Click(object sender, EventArgs e)
        {
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=Subway_Prévia.xls");
            Response.Charset = "";
            Response.ContentType = "application/vnd.ms-excel";
            using (StringWriter sw = new StringWriter())
            {
        ...
        {
            Lbel01.Text = "Data selecionada " + Calendar1.SelectedDate.ToShortDateString();
            Lbel2.Visible = true;
            Lbel01.Visible = true;
            Label2.Visible = true;
        }
        ...
        protected void BtnExcel2_Click(object sender, EventArgs e)
        {
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=Subway_Exp_SAP.xls");
            Response.Charset = "";
            Response.ContentType = "application/vnd.ms-excel";
            using (StringWriter sw = new StringWriter())
            {
