<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportaExcelMania.aspx.cs" Inherits="JFCWEB.Administrador.ExportaExcelMania" %>
...
<body>
    ...
    <div class="style2" style="text-align: center">
        ...
        <div>
            ...
            <asp:Label ID="Label5" runat="server" Text="Mania de Churrasco" ForeColor="#009532" style="font-size: x-large; font-weight: 700"></asp:Label>
                    </td>
