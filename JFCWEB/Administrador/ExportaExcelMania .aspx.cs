...
{
    public partial class ExportaExcelMania : System.Web.UI.Page
    {
  ...
  string strConnstring = "Data Source=mssql02-farm22.kinghost.net;Initial Catalog=jfcverduras;Integrated Security=True;Pooling=False";
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Mania_RJ_MG.xls");
            Response.Charset = "";
        ...
        protected void btnExcel1_Click(object sender, EventArgs e)
        {
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=Mania_SP.xls");
            Response.Charset = "";
            Response.ContentType = "application/vnd.ms-excel";
        ...
        protected void BtnPrevia_Click(object sender, EventArgs e)
        {
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=Mania_Prévia.xls");
            Response.Charset = "";
            Response.ContentType = "application/vnd.ms-excel";
            using (StringWriter sw = new StringWriter())
            {
        ...
        protected void btnExcel2_Click(object sender, EventArgs e)
        {
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=Mania_Exp_SAP.xls");
            Response.Charset = "";
            Response.ContentType = "application/vnd.ms-excel";
            using (StringWriter sw = new StringWriter())
            {
        ...
        protected void btnExcel3_Click(object sender, EventArgs e)
        {
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=Mania_PR.xls");
            Response.Charset = "";
            Response.ContentType = "application/vnd.ms-excel";
            using (StringWriter sw1 = new StringWriter())
            {
