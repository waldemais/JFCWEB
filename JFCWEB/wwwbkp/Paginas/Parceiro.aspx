...
<body>
                ...
                <tr>
                    ...
                    <td class="style3">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            DataSourceID="SqlDataSource1" Width="697px" Height="77px">
                            <Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        InsertCommand="INSERT INTO TGFPAR(CODPARC, NOMEPARC, CGC_CPF) VALUES (@CODPARC, @NOMEPARC, @CGC_CPF)" 
        SelectCommand="SELECT DISTINCT CODPARC, CGC_CPF, NOMEPARC, EMAIL, UF, ROTA FROM TGFPAR WHERE (CODPARC = @CODPARC)" 
                ...
                UpdateCommand="UPDATE TGFPAR SET CODPARC = @CODPARC, NOMEPARC = @NOMEPARC, CGC_CPF = @CGC_CPF, EMAIL = @EMAIL, UF = @UF, ROTA = @ROTA WHERE (CODPARC = @CODPARC)">
        <DeleteParameters>
