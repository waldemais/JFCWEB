...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width: 100%; height: 267px;">
            ...
            <td class="style1">
                <h2 class="titulo-pagina" 
                    ...
                    <asp:ImageButton ID="ImageButton2" runat="server" ImageAlign="Left" 
                        ImageUrl="~/Imagem/icons8-menu-48.png" PostBackUrl="~/Cliente/Menu4.aspx" 
                        Width="50px" />
                    Perfil</h2>
            </td>
            <td class="style2">
        ...
        <tr>
            <td class="style1">
                <asp:ImageMap ID="ImageMap1" runat="server" ImageUrl="~/Imagem/boneco.png" 
                    Width="150px">
                </asp:ImageMap>
                <br />
                <br />
        ...
        <tr>
            ...
            <td class="style2">
                ...
                <asp:TextBox ID="TxtBx5" runat="server" Width="150px" AutoPostBack="True" 
                    ontextchanged="TxtBx5_TextChanged" TextMode="Password"></asp:TextBox>
&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="TxtBx6" runat="server" Width="150px" TextMode="Password"></asp:TextBox>
&nbsp;
&nbsp;<asp:TextBox ID="TxtBx10" runat="server" Width="150px" TextMode="Password"></asp:TextBox>
            &nbsp;
            </td>
            <td>
