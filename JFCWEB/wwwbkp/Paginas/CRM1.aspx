    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div>
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:jfcwConnectionString %>" SelectCommand="SELECT DISTINCT Id, Dtatual, CGC, Nomepar, Status, Ocor FROM CRM1 WHERE (Status = 'Aberto')"></asp:SqlDataSource>
            </div>
            <br />
            <br />
        </div>
