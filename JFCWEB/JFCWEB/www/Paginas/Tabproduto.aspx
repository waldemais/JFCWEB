...
&nbsp;<br />
        ...
        <asp:Panel ID="Panel1" runat="server" Height="259px" style="margin-top: 34px">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                DataSourceID="SqlDataSource1" GridLines="None" style="color: #009933">
                <Columns>
                    <asp:BoundField DataField="IDPRO" HeaderText="id" ReadOnly="True" 
                        SortExpression="IDPRO" >
...
&nbsp;
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT DISTINCT CODPROD, DESCRPROD, IDPRO FROM ItemParceiros WHERE (CODPARC = @CODPARC) ORDER BY DESCRPROD">
        <SelectParameters>
