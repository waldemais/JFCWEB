...
<body>
        ...
        <tr>
            <td class="auto-style5" align="char">
                ...
                <asp:Calendar ID="Calendar1" runat="server" BackColor="White" 
                    ...
                    onselectionchanged="Calendar1_SelectionChanged" NextPrevFormat="ShortMonth" BorderStyle="Solid" CellSpacing="1">
                    ...
                    <TitleStyle BackColor="#333399" 
                        Font-Bold="True" Font-Size="12pt" ForeColor="White" BorderStyle="Solid" Height="12pt" />
    ...
    <div>
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:jfcwConnectionString %>" SelectCommand="SELECT DTENTREGA, pedidoID, CODPARSAP, CODPROSAP, DESCRPROD, QTDE, PADRAO FROM ExportaSap WHERE (DTENTREGA = @DTENTREGA) AND (QTDE &gt; 0) ORDER BY CODPARSAP">
                    <SelectParameters>
