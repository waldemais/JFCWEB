            ...
            <SelectParameters>
                <asp:ControlParameter ControlID="TxtBox1" Name="CGC_CPF" PropertyName="Text" 
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                        ...
                        SelectCommand="SELECT DISTINCT DTENTREGA, ATIVO, CGC_CPF FROM PedEntrega WHERE (CGC_CPF = @CGC_CPF) AND (ATIVO = 'True') AND (DTENTREGA &lt;&gt; '25/12/2022') AND (DTENTREGA &lt;&gt; '01/01/2023') ORDER BY DTENTREGA">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="TxtBox1" Name="CGC_CPF" PropertyName="Text" 
                                Type="String" />
                        </SelectParameters>
