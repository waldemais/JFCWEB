    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:Label ID="Label14" runat="server" Text="Anexar Foto"></asp:Label>
                        <br />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="FileUp" ErrorMessage="Obrigatótio Anexar uma foto." ForeColor="Red" Width="200px" Enabled="False">(*) Campo Obrigatório</asp:RequiredFieldValidator>
        ...
        <div>
            <h3 class="auto-style46">
                        ...
                        <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True" ForeColor="Red" Height="35px" Enabled="False" />
            <hr />
            <h3 class="auto-style46">
        ...
        <div>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Informe a descrição detalhada." ForeColor="Red" Width="200px" ControlToValidate="TBox11" Enabled="False">(*)  Preenchimento Obrigatório</asp:RequiredFieldValidator>
        </div>
