...
<body>
    ...
    <div class="style2" style="text-align: center">
        ...
        <div>
            ...
            <asp:Label ID="Label5" runat="server" Text="KFC/SH" ForeColor="#009532" style="font-size: x-large; font-weight: 700"></asp:Label>
                ...
                <tr>
                    <td class="auto-style25" align="center">
                        <asp:Button ID="Button1" runat="server" PostBackUrl="~/Administrador/Menu1.aspx" Text="Menu" Width="100px" />
                    </td>
            ...
            <hr />
            <asp:Label ID="Label6" runat="server" Text="Exportar para Excel"></asp:Label>
        </div>
        <h2 class="style3">
            <table style="width:100%;">
                <tr>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td class="auto-style3" colspan="2">
                ...
                <br />
                <asp:GridView ID="dgv1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource3" GridLines="Horizontal" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Font-Size="X-Small" Width="800px" ForeColor="Black">
                    <Columns>
        ...
        <tr>
            <td class="auto-style4" colspan="2">
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ...
                    SelectCommand="SELECT CODPROD, DESCRPROD, SUM(QTDE) AS Expr1 FROM Previa WHERE (DTENTREGA = @DTENTREGA) AND (NOMEPARC LIKE 'KFC%') OR (NOMEPARC LIKE 'SH%') GROUP BY CODPROD, DESCRPROD" ProviderName="System.Data.SqlClient">
                    <SelectParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT DISTINCT pedidoID, DTENTREGA, NOMEPARC, CODPROD, DESCRPROD, QTDE, STATUS, CODPARC, UF, ROTA FROM Exporta WHERE (DTENTREGA = @DTENTREGA) AND (QTDE &lt;&gt; 0) AND (UF IN ('RJ', 'MG', 'NULL')) AND (NOMEPARC LIKE 'KFC%') AND (STATUS = 'ABERTO') OR (NOMEPARC LIKE 'SH%')" ProviderName="System.Data.SqlClient">
            <SelectParameters>
                <asp:ControlParameter ControlID="Calendar1" DbType="Date" Name="DTENTREGA" 
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            SelectCommand="SELECT DISTINCT pedidoID, DTENTREGA, NOMEPARC, CODPROD, DESCRPROD, QTDE, STATUS, CODPARC, UF, ROTA FROM Exporta WHERE (DTENTREGA = @DTENTREGA) AND (STATUS = 'ABERTO') AND (QTDE &lt;&gt; 0) AND (UF = 'SP') AND (NOMEPARC LIKE 'KFC%') OR (NOMEPARC LIKE 'SH%') ORDER BY CODPARC" ProviderName="System.Data.SqlClient">
            <SelectParameters>
                <asp:ControlParameter ControlID="Calendar1" DbType="Date" Name="DTENTREGA" 
                    PropertyName="SelectedDate" DefaultValue="" />
            </SelectParameters>
    ...
    <div>
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:jfcverdurasConnectionString %>" SelectCommand="SELECT DTENTREGA, pedidoID, CODPARSAP, CODPARC, CODPROSAP, DESCRPROD, QTDE, PADRAO, STATUS, NOMEPARC FROM ExportaSap WHERE (DTENTREGA = @DTENTREGA) AND (QTDE &gt; 0) AND (STATUS &lt;&gt; 'CANCELADO') AND (NOMEPARC LIKE '%KFC%') OR (NOMEPARC LIKE 'SH%') ORDER BY CODPARC" ProviderName="System.Data.SqlClient">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="Calendar1" DbType="Date" Name="DTENTREGA" PropertyName="SelectedDate" />
                    </SelectParameters>
        </asp:SqlDataSource>
