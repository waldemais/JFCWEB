<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Relatorio1.aspx.cs" Inherits="JFCWEB.Paginas.Relatorio1" %>
...
<body>
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
        DataSourceID="SqlDataSource4" BackColor="White" BorderColor="#999999" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="PADRAO1" HeaderText="Unit." SortExpression="PADRAO1" >
        ...
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="Data Source=mssql02-farm22.kinghost.net;Initial Catalog=jfcverduras;Persist Security Info=True;User ID=jfcverduras;Password=Campanha#2025;Encrypt=False" ProviderName="System.Data.SqlClient" SelectCommand="SELECT DISTINCT itemID, pedidoID, CODPROD, QTDE, DESCRPROD, TOTAL, PADRAO1, PADRAO FROM VLISTPRO WHERE (pedidoID = @pedidoID) AND (QTDE &lt;&gt; 0) ORDER BY DESCRPROD">
            <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        SelectCommand="SELECT DISTINCT itemID, pedidoID, CODPROD, QTDE, DESCRPROD, TOTAL, PADRAO1 FROM VLISTPRO WHERE (pedidoID = @pedidoID) AND (QTDE &lt;&gt; 0) ORDER BY DESCRPROD" ProviderName="System.Data.SqlClient">
        <SelectParameters>
            <asp:ControlParameter ControlID="TextBx1" Name="pedidoID" PropertyName="Text" 
                Type="Int32" />
        </SelectParameters>
