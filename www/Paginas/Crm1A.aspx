...
&nbsp;&nbsp;&nbsp;
            ...
            <div>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" Visible="False">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Nomeaprov" HeaderText="Nomeaprov" HtmlEncode="False" SortExpression="Nomeaprov" NullDisplayText="aprovador" />
                        <asp:BoundField DataField="Emailaprov" HeaderText="Emailaprov" HtmlEncode="False" SortExpression="Emailaprov" NullDisplayText="email aprovador" />
                        <asp:BoundField DataField="Qreclamada" HeaderText="Qreclamada" SortExpression="Qreclamada" />
                        <asp:BoundField DataField="Qautoriz" HeaderText="Qautoriz" SortExpression="Qautoriz" NullDisplayText="0" />
                        <asp:BoundField DataField="Obser" HeaderText="Obser" HtmlEncode="False" SortExpression="Obser" NullDisplayText="Descrição Detalhada" />
                    </Columns>
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        <td colspan="4" class="auto-style1">
                            ...
                            <strong>
                            <br />
                            <asp:Label ID="Label4" runat="server" Text="Ação Tomada"></asp:Label>
                            </strong>
                            <br />
                            <asp:TextBox ID="TextBox6" runat="server" Height="145px" TextMode="MultiLine" Width="518px" Enabled="False" ReadOnly="True">NÃO HÁ JUSTIFICATIVA INFORMADA.</asp:TextBox>
                        </td>
                    </tr>
                </table>
                <br />
                <div class="auto-style1">
                    <asp:HyperLink ID="hplnkExibeImagem" runat="server" BackColor="#CCFFCC" Font-Size="Medium" Target="_blank">Click aqui para exibir a Imagem</asp:HyperLink>
                </div>
                <br />
                <br />
            </asp:Panel>
        ...
        <div class="auto-style1">
            <asp:Button ID="Button1" runat="server" BackColor="#E7EBEF" Font-Bold="True" Text="Voltar" Width="100px" OnClientClick="JavaScript:window.history.back(1); return false" />
