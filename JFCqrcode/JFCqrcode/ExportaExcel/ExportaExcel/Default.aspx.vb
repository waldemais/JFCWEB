...
Public Class _Default
    ...
    Private Sub incluir_dados()
        ...
        For i = 0 To gdvNotas.Rows.Count - 1
            Dim query As String = "insert into Notas values ('" + gdvResumoNotas.Rows(i).Cells(0).Text + "','" + gdvResumoNotas.Rows(i).Cells(1).Text.ToString() + "','" + gdvResumoNotas.Rows(i).Cells(2).Text.ToString() + "','" + gdvResumoNotas.Rows(i).Cells(3).Text + "')"
